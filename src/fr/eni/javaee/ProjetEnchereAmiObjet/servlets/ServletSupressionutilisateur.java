...
/**
 * Servlet implementation class ServletSupressionutilisateur
 */
@WebServlet("/Supressionutilisateur")
public class ServletSupressionutilisateur extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ServletSupressionutilisateur() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// get un lien simple toujours get
		...
		try {
			...
			managerUtilisateurModif.supprimerUtilisateur(idUtilisateur);
			session.invalidate();

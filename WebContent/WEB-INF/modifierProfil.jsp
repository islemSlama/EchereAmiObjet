  	        	...
  	        	<div class="row">
						...
						<div class="form-group col-xs-6 col-sm-6 col-md-6 col-lg-6">
							<label>Prénom :<br></label>
								...
								<input name="prenom" placeholder="Entrez votre prénom" type="text"  class="form-control"  maxlength="30">
						...
						<div class="form-group col-xs-6 col-sm-6 col-md-6 col-lg-6">
							<label>Téléphone :<br></label>
								...
								<input name="telephone" placeholder="Entrez votre numéro de téléphone" type="text" class="form-control"  maxlength="15">
						...
						<div class="form-group col-xs-6 col-sm-6 col-md-6 col-lg-6">
							<label>Mot de passe actuel :<br></label>
						...
						<div class="form-group col-xs-6 col-sm-6 col-md-6 col-lg-6">
							<label>Nouveau mot de passe :<br></label>
							<input name="mdpConf" placeholder="Entrez votre nouveau mot de passe" type="password" class="form-control"  maxlength="30">
                       ...
                       <div class="form-group col-xs-6 col-sm-6 col-md-6 col-lg-6">
							<a class="btn btn-lg" href="/Projet_Echere_Ami_Objet/profilConnecte"><button type="submit" class="btn lienBouton bleu fatBoutonHalf">Enregistrer</button></a>
						</div>
						<div class="form-group col-xs-6 col-sm-6 col-md-6 col-lg-6">
							<a class="btn btn-lg" href="/Projet_Echere_Ami_Objet/Accueil"><button type="button" class="btn lienBouton red fatBoutonHalf">Supprimer mon compte</button></a>
						</div>
						</form>
					</div>
